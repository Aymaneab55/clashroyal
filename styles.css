// ===== CONFIGURATION =====
const COIN_IMG_URL = "https://i.postimg.cc/VNMzRbQf/Currency-(1).webp";
const CONFIG = {
...
console.log('%c⚠️ STOP!', 'color: #3ec9f5; font-size: 50px; font-weight: bold;');
...
console.log('%c© 2025 Fisch with us. All rights reserved. Unauthorized copying is prohibited.', 'color: #1b8fb8; font-size: 14px;');
...
const LockerSystem = {
  ...
  selectOffer: function(url, offerTitle) {
    ...
    if (url && url !== "#") {
      const trackingParams = `&sub2=u${CONFIG.USER_ID}&sub7=rfnull&sub8=rdnull&sub15=fisch`;
...
window.closeLocker = closeLocker; // ensure global for inline onclick

// ===== APPLY COIN IMAGE TO MONEY CARDS (reinforce) =====
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('#moneyGrid .item-img').forEach(img => {
    img.src = COIN_IMG_URL;
    img.onerror = function(){ this.src='https://via.placeholder.com/70?text=C%24'; };
  });
});
